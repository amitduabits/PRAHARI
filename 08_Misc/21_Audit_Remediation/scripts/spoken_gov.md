# Gov-feed spoken script (locked, ≤3 min)
...
Do not say: these pins are the government cameras; we OCRed Paldi; we downloaded the sandbox file; 80k measured; face recognition on this feed.
